...
"""
	Implementation of BinaryConstraint
	Satisfied if both values are not next to or equal to each other
"""
class NotAdjacentConstraint(BinaryConstraint):
	def isSatisfied(self, value1, value2):
		if abs(ord(value1) - ord(value2)) <= 1:
			return False
		return True
...
"""
	Implementation of BinaryConstraint
	Satisfied if both values are next to, but not equal, to each other
"""
